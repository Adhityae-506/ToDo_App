...
const Sidebar = () => {
  ...
  return(
    <div className="w-64 h-screen bg-red-400 text-white p-6">
      <h1 className="text 2-xl font-bold mb-10">Dashboard</h1>

      <nav className="flex flex-col pag-4">
        <button className="text-left">Dashboard</button>
        <button className="text-left">Tasks</button>
        <button className="text-left mt-auto">Logout</button>
      </nav>
    </div>
  );
};
